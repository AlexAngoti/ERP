    ...
    object TabSheet11: TTabSheet
      ...
      object MemoUpdate: TMemo
        ...
        Lines.Strings = (
          ...
          ''
          'ALTER TABLE empresa ADD USAR_TRIB_TODAS_EMP VARCHAR(1);'
          ''
          'ALTER TABLE empresa ADD USAR_TRIB_XML VARCHAR(1);'
          ''
          'ALTER TABLE empresa ADD USAR_NUMERO_INICIAL VARCHAR(1);'
          ''
          'ALTER DOMAIN RDB$854 TYPE NUMERIC(15,2);'
          ''
          'ALTER DOMAIN RDB$859 TYPE NUMERIC(15,2);'
          ''
          'ALTER DOMAIN RDB$889 TYPE NUMERIC(15,2);'
          ''
          'ALTER DOMAIN RDB$890 TYPE NUMERIC(15,2);'
          ''
          'ALTER DOMAIN RDB$23144 TYPE NUMERIC(15,2);'
          ''
          'ALTER DOMAIN RDB$23145 TYPE NUMERIC(15,2);'
          ''
          'ALTER DOMAIN RDB$23146 TYPE NUMERIC(15,2);'
          ''
          'ALTER DOMAIN RDB$23147 TYPE NUMERIC(15,2);'
          ''
          'ALTER DOMAIN RDB$24828 TYPE NUMERIC(15,2);'
          ''
          'ALTER DOMAIN RDB$29417 TYPE NUMERIC(15,2);'
          ''
          'ALTER DOMAIN RDB$32175 TYPE NUMERIC(15,2);'
          ''
          'ALTER DOMAIN RDB$793 TYPE VARCHAR(100);'
          ''
          'UPDATE config SET versao = 430;'
          ''
          'UPDATE config SET data_script = '#39'08.12.2022'#39';'
          ''
          'DROP TRIGGER TRG_CHAVE_CARGA;'
          ''
